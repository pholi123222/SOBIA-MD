...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "JbdFBRiY#nsVeUv2FLXbVLXhcQtX8kujNyfQOMknIUFzjzkjd9cc",
    ...
    DEV: process.env.DEV || "27699204243",//replace with your whatsapp number        
